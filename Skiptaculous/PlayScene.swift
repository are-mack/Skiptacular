...
class PlayScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView!){
        ...
        self.backgroundColor = UIColor (hex:0x8D9FF)
...
//Block Positions
        ...
        self.block2.position = CGPointMake(CGRectGetMaxX(self.frame) + self.block1.size.width, self.heroBaseline + self.block1.size.height / 2)
